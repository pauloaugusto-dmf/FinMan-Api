...
RSpec.describe Api::TransactionsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #update via PUT' do
      expect(put: '/api/accounts/1/transaction/1').to route_to('api/transactions#update', format: :json, account_id: '1', id: '1')
    end

    it 'routes to #update via PATCH' do
      expect(patch: '/api/accounts/1/transaction/1').to route_to('api/transactions#update', format: :json, account_id: '1', id: '1')
    end

    it 'routes to #destroy' do
      expect(delete: '/api/accounts/1/transaction/1').to route_to('api/transactions#destroy', format: :json, account_id: '1', id: '1')
    end
  end
end
